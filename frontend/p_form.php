...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="p_form.css">
  </head>
 <body>
 
     <div class="container">
       <form action="p_form_processor.php" method="POST">
      <h3>Made Request</h3>
...
<div class="row">
      <div class="col">
            <label>Reason</label>
          <input name="reason" type="text" class="form-control"  aria-label="reason">
...
<div>
          ...
          <input name="hospital" type="text" class="form-control" placeholder="" aria-label="hospital" style="margin-bottom: 10px;">
  </div>
