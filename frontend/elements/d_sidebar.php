   ...
   <div class="offcanvas-body p=0">
       <nav class ="navbar-dark">
           <ul class="navbar-dark">
               <li>
                   <div class="text-muted small fw-bold text-uppercase px-3"> Donor DashBoard
               ...
               <span class="text-secondary" >Home</span>
                   ...
                   <span class="text-secondary" >Donate Blood</span>
                   </a><br>
                   <a href="donor_form.php" class="nav-link px-3 active">
                       <span class="text-secondary">
                        <i class="bi bi-card-list"></i>
                   </span>
                   <span class="text-secondary" >Donor Request Form</span>
                   </a><br>
                   <a href="#" class="nav-link px-3 active">
                       <span class="text-secondary">
