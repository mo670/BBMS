       ...
       <div class="row">
           ...
           <form action="create_donor_processor.php" method="post">
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                <div class="col-md-12">
                    <label for="disease" class="text-black">Disease(if any) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="disease" name="disease" placeholder="">
                  </div> 
                  <div class="col-md-12">
     
                       <div class="form-outline">
                         <label class="form-label" for="last_donation">Last Donation</label>
                         <input name="last_donation" type="date" id="last_donation" class="form-control form-control-lg" />
                       </div>
